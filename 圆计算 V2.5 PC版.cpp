/*
圆计算 V2.5 PC版  版权所有 (C) 黑米粥工作室
本程序采用 GNU 通用公共许可证 进行授权。
...
int main()
{
	...
	<<"圆计算 V2.5 PC版 程序，解决大家的圆计算难题。（π取3.14，默认保留6位有效数字）\n\n"
	...
	<<"……\n"
	<<"重磅 - “圆计算”即将升级为“平面图形计算”\n"
	<<"光阴似箭，转眼间，黑米粥工作室旗下的“圆计算”程序已经从最初的V0.1版走到了现在的V2.5版，"
	<<"V3.0版重大更新即将迎来。经黑米粥工作室决定，V3.0版即将升级为“平面图形计算”，"
	<<"涵盖几乎所有小学知识涉及到的平面图形各数据计算。\n在V3.0版更新之前，“圆计算”程序V2.X系列"
	<<"可能还会有一段时间的更新。具体更新事宜将在V3.0版本之前的一个版本说明。\n\n" 
	<<"有人可能会问，为什么通用版不能像PC版那样清屏改颜色。这个问题黑米粥工作室也没法解决，"
	<<"因为清屏和改颜色是用Windows的批处理命令实现的，而其他平台上是否也有类似的命令，"
	<<"黑米粥工作室尚未得知。如果大家有什么好的建议，欢迎联系我们。\n\n"
	<<"本程序项目的官方网站是【https://zh.cppreference.com/w/Heymmy-Zhou-01:圆计算】。\n\n";
	system("pause");
	system("cls");
	cout<<"本程序采用 GNU 通用公共许可证 进行授权。\n\n"
	...
	system("cls");
	cout<<"如在使用过程中有任何问题，请联系黑米粥工作室：\n"
	<<"QQ：3547888247\n邮箱：3547888247@qq.com\n"
	<<"如因擅自使用本程序所造成的一切后果，黑米粥工作室概不负责。\n\n"; 
